...
class TestApiClient implements QueResourceAPI {
  public getVideoDownloadURL = async (storageURL: string) => {
  ...
  public getImageDownloadURL = async (storageURL: string) => {
  ...
  public getVideoCardData = getTestVideoCardData;
}
